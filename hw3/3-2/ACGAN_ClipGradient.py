...
from ACGAN_Discriminator2 import MyDiscriminator
from ACGAN_Generator2 import MyGenerator
import os
...
class ACGAN():
    ...
    def train_D(self, batch):#, miss_labels):
        ...
        d_real_loss = -real_score.mean()
        
        d_fake_loss = fake_score.mean()
...
#         input("")
    ...
    def plot_images(self, save2file=True, step=0):
        ...
        if not os.path.exists("./ACGAN_CGimages"):
            os.makedirs("./ACGAN_CGimages")
        filename = "./ACGAN_CGimages/animate_%d.png" % step
        """
