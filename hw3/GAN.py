...
from GAN_Discriminator import MyDiscriminator
import os
...
class GAN():
    def __init__(self, width=64, height=64, channels=3, clip_value=0.01, latent_dim = 300, D_update_times = 1):
    ...
    def train(self, datas, epochs=10000, batch_size = 256, save_interval = 1):
        ...
        while(self.epoch < epochs):
            ...
            if self.epoch % save_interval == 0:
                ...
                'd_real': d_real_loss,
                'd_fake': d_fake_loss,
                }, dir_name+"/GAN" + str(self.epoch))
                self.plot_images(save2file=False, step=self.epoch)
